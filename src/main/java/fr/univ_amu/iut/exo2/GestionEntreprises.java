...
public class GestionEntreprises {
    public static void main(String[] args) {
        ...
        EmployeOrdinaire Axel = new EmployeOrdinaire(13,"1234567890","RIBES","axel",99,dateNaissanceAxel,dateEmbaucheAxel,9.88,140);
        Technicien Theo = new Technicien(0,"1","POUJOL","Theo",0,dateNaissanceAxel,dateEmbaucheAxel,9.88,140);
        Theo.setNbUnitesProduites(2500);
        Theo.setTauxCommissionUnite(0.03);
